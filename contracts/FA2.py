...
if "templates" not in __name__:
    ...
    sp.add_compilation_target("compile",FA2(FA2_config(non_fungible = True),admin = sp.address("tz1UCizQ3bNAVipFBK7YwVGPVmeKLES3LwyQ"), metadata = sp.utils.metadata_of_url("ipfs://bafkreiewnvr2t75jcwty7tkl2jzq2o566phqc4h6xas252lpwfpgfu6pvi")))
